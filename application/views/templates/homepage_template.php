				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 sm-margin-bottom-40">
							<div class="heading-footer"><h2>Om Reeo.se</h2></div>
							<p>Reeo.se är en sajt för dig som vill hitta rabattkoder, erbjudanden, aktuell REA på specefik produkt och mycket annat. Sidan uppdateras dagligen!</p>
						...
						<!-- Useful Links -->
						<div class="col-md-3 sm-margin-bottom-40">
							<div class="heading-footer"><h2>Länkar </h2></div>
							<ul class="list-unstyled footer-link-list">
								<li><a href="http://blogg.reeo.se">Bloggen</a></li>
								<li><a href="<?php echo base_url('sitemap.xml'); ?>">Sitemap</a></li>
								<li><a href="<?php echo base_url('sekretessinformation'); ?>">Sekretessinformation</a></li>
